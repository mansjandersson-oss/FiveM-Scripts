Locales = {
    en = {
        ...
        civilian_vehicle_ready   = 'Find a %s already on the streets and drive it to the chop zone.',
    ...
    sv = {
        ...
        civilian_vehicle_ready   = 'Hitta en %s som redan rör sig på gatorna och kör den till chopzonen.',
